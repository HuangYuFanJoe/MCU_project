...
char GetChar(void)
{
#line 118 "..\\..\\..\\Src\\Driver\\retarget.c"
	...
	{
		while (1){
			if(((UART_T *) ((( uint32_t)0x40100000) + 0x54000))->FSR.RX_EMPTY == 0 )
			{
				return (((UART_T *) ((( uint32_t)0x40100000) + 0x54000))->DATA);
...
#line 228 "..\\..\\..\\Src\\Driver\\retarget.c"
